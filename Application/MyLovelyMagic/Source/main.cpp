...
public:
	virtual bool SetUp(int clientWidth, int clientHeight, bool fullScreen, const char* arg)
	{
		...
		MK_PAGE_MGR.RegisterChildPage(GamePageRoot::Name, new GamePageClientStart);
		MK_PAGE_MGR.RegisterChildPage(GamePageRoot::Name, new GamePageMainTitle);

		MK_PAGE_MGR.SetPageFlowTable(GamePageClientStart::Name, L"ToNext", GamePageMainTitle::Name);
...
int WINAPI WinMain(HINSTANCE hI, HINSTANCE hPI, LPSTR cmdline, int iWinMode)
{
	...
	application.Run(hI, L"My Lovely Magic", L"..\\FileRoot", true, eSWP_FixedSize, CW_USEDEFAULT, CW_USEDEFAULT, 1024, 768, false, false, NULL, cmdline);
