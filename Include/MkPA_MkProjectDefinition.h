...
// image subset 파일 확장자
#define MKDEF_PA_IMAGE_SUBSET_FILE_EXTENSION L"mis"

// image subset 파일에서 group key
#define MKDEF_PA_IMAGE_SUBSET_FILE_GROUP_KEY L"Group"

// image subset 파일에서 위치 값 key
#define MKDEF_PA_IMAGE_SUBSET_FILE_POSITION_KEY L"Position"

// image subset 파일에서 크기 값 key
#define MKDEF_PA_IMAGE_SUBSET_FILE_SIZE_KEY L"Size"

// image subset 파일에서 조각 배열 값 key
#define MKDEF_PA_IMAGE_SUBSET_FILE_QUILT_KEY L"Quilt"

// image subset 파일에서 테이블 배열 값 key
#define MKDEF_PA_IMAGE_SUBSET_FILE_TABLE_KEY L"Table"
...
//#define MKDEF_PA_DEBUG_SHOW_SRECT_SET_INFO
