...
#define MKDEF_PANEL_FVF (D3DFVF_XYZ | D3DFVF_TEX1 | D3DFVF_TEXCOORDSIZE2(0))
#define MKDEF_LINESHAPE_FVF (D3DFVF_XYZ | D3DFVF_DIFFUSE)
#define MKDEF_MAX_TEXTURE_COUNT 8
