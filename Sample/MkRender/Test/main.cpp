...
public:
	virtual bool SetUp(MkDataNode& sharingNode)
	{
		...
		tagInfo.captionStr = L"²¿²¿ºØ 1-0";
		g1->AddItem(L"1-0", tagInfo, false);
		tagInfo.captionStr = L"²¿²¿ºØ 1-1";
		g1->AddItem(L"1-1", tagInfo, false);
		tagInfo.captionStr = L"²¿²¿ºØ 1-2";
		...
		tagInfo.captionStr = L"²¿²¿ºØ 3-0";
		g3->AddItem(L"3-0", tagInfo, false);
		tagInfo.captionStr = L"²¿²¿ºØ 3-1";
		MkSpreadButtonNode* g31 = g3->AddItem(L"3-1", tagInfo, false);
		tagInfo.captionStr = L"²¿²¿ºØ 3-1-0";
